    ...
    Source file: ./benchmarks/Benchmark_mobius_mpc.cc
...
#define COMPARE(r_o,ref) \
  ...
  typedef typename FermionOp::Coeff_t Coeff_t;
  ...
  SchurDiagOneRH<FermionOp,LatticeFermion>           SchurRH(Dw);
  SchurDiagOneFusedRH<FermionOp,LatticeFermion> FusedSchurRH(Dw);
  ...
  SchurDiagOneLH<FermionOp,LatticeFermion>           SchurLH(Dw);
  SchurDiagOneFusedLH<FermionOp,LatticeFermion> FusedSchurLH(Dw);
  ...
  SchurDiagMooeeOperator<FermionOp,LatticeFermion> SchurMooee(Dw);
  SchurDiagMooeeFused<FermionOp,LatticeFermion>    FusedSchurMooee(Dw);
