...
void getNumBlocksAndThreads(const Iterator n, const size_t sizeofsobj, Iterator &threads, Iterator &blocks) {
  ...
  Iterator warpSize            = gpu_props.warpSize;
  Iterator sharedMemPerBlock   = gpu_props.sharedMemPerBlock;
  Iterator maxThreadsPerBlock  = gpu_props.maxThreadsPerBlock;
  Iterator multiProcessorCount = gpu_props.multiProcessorCount;
...
template <class vobj>
inline typename vobj::scalar_object reduce(const Lattice<vobj> &lat) {
